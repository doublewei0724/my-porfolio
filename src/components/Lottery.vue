<template>
  <div class="max-w-[500px] m-auto">
    ...
    <div class="header flex justify-between items-center p-2 relative"
      :style="`background: url(${baseUrl}kjw/images/header_bg.png); background-size: auto 100%`">
    ...
    <div>
      <div class="bg-[#f7e1ac] flex flex-col px-2">
        <div
          ...
          <img :src="baseUrl + 'kjw/images/logo.svg'" alt="" class="w-6 h-6 mr-1" />
          <span class="text-[#61350b] text-lg">彩票频道主办</span>
        </div>
        <div class="flex items-center text-[#61350b] font-black">
          <img :src="baseUrl + 'kjw/images/gold_medal.svg'" alt="" class="w-8 h-8 mr-1" />
      ...
      <div class="bg-gradient-to-t from-[#fdf4e1] to-[#f7e1ac] p-2 grid grid-cols-3 gap-2">
        <div v-for="animal in animals" :key="animal.id"
          ...
          <img :src="baseUrl + 'kjw/images/medal.gif'" alt="medal" class="absolute top-0 right-0.5 w-7 h-auto" />
    ...
    <footer class="py-5 px-3 bg-gradient-to-t from-[#fdf4e1] to-[#f7e1ac]">
      <div class="container mx-auto flex justify-evenly items-center">
        <div class="flex">
          <img :src="baseUrl + 'kjw/images/footer_icon_1.svg'" alt="" class="w-auto h-10" />
          <img :src="baseUrl + 'kjw/images/footer_icon_2.svg'" alt="" class="w-auto h-10" />
        </div>
        <div class="flex">
          <img :src="baseUrl + 'kjw/images/footer_icon_3.svg'" alt="" class="w-auto h-10" />
          <img :src="baseUrl + 'kjw/images/footer_icon_4.svg'" alt="" class="w-auto h-10" />
        </div>
        <div class="flex">
          <img :src="baseUrl + 'kjw/images/footer_icon_5.svg'" alt="" class="w-auto h-10" />
          <img :src="baseUrl + 'kjw/images/footer_icon_6.svg'" alt="" class="w-auto h-10" />
        </div>
      </div>
    </footer>
  </div>
...
const animals = ref([
  {
    ...
    color: "#d03125",
    image: baseUrl + "kjw/images/icon_1.png",
    animalImage: baseUrl + "kjw/images/animal_1.png",
  },
  {
    id: 2,
    name: "盒马",
    ...
    color: "#134e91",
    image: baseUrl + "kjw/images/icon_2.png",
    animalImage: baseUrl + "kjw/images/animal_2.png",
  },
  {
    id: 3,
    name: "票票",
    ...
    color: "#008b8b",
    image: baseUrl + "kjw/images/icon_3.png",
    animalImage: baseUrl + "kjw/images/animal_3.png",
  },
  {
    id: 4,
    name: "虾仔",
    englishName: "Xiazai",
    color: "#f6e58d",
    image: baseUrl + "kjw/images/icon_4.png",
    animalImage: baseUrl + "kjw/images/animal_4.png",
  },
  {
    id: 5,
    name: "支小宝",
    ...
    color: "#8b008b",
    image: baseUrl + "kjw/images/icon_5.png",
    animalImage: baseUrl + "kjw/images/animal_5.png",
  },
  {
    id: 6,
    name: "欢猩",
    ...
    color: "#8b4513",
    image: baseUrl + "kjw/images/icon_6.png",
    animalImage: baseUrl + "kjw/images/animal_6.png",
  },
]);
...
const getImagePath = (number) => {
  ...
  return `${baseUrl}kjw/images/history_${number}.png`;
};
