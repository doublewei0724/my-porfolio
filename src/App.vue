<template>
  ...
  <div
    ...
    style="
      background: url(/my-porfolio/images/header_bg.png);
      background-size: auto 100%;
    "
  >
    <div class="flex items-center gap-2">
      <img src="/my-porfolio/images/logo_title.svg" alt="Logo" class="h-10" />
    </div>
  ...
  <div>
    <div class="bg-[#f7e1ac] flex flex-col px-2">
      ...
      >
        <img src="/my-porfolio/images/logo.svg" alt="" class="w-6 h-6 mr-1" />
        <span class="text-[#61350b] text-lg">彩票频道主办</span>
      </div>
      <div class="flex items-center text-[#61350b] font-black">
        <img src="/my-porfolio/images/gold_medal.svg" alt="" class="w-8 h-8 mr-1" />
    ...
    >
      ...
      >
        ...
        <img
          src="/my-porfolio/images/medal.gif"
          alt="medal"
  ...
  <footer class="py-5 px-3 bg-gradient-to-t from-[#fdf4e1] to-[#f7e1ac]">
    <div class="container mx-auto flex justify-evenly items-center">
      <div class="flex">
        <img
          src="/my-porfolio/images/footer_icon_1.svg"
          alt=""
          class="w-auto h-10"
        />
        <img
          src="/my-porfolio/images/footer_icon_2.svg"
          alt=""
          class="w-auto h-10"
        />
      </div>
      <div class="flex">
        <img
          src="/my-porfolio/images/footer_icon_3.svg"
          alt=""
          class="w-auto h-10"
        />
        <img
          src="/my-porfolio/images/footer_icon_4.svg"
          alt=""
          class="w-auto h-10"
        />
      </div>
      <div class="flex">
        <img
          src="/my-porfolio/images/footer_icon_5.svg"
          alt=""
          class="w-auto h-10"
        />
        <img
          src="/my-porfolio/images/footer_icon_6.svg"
          alt=""
          class="w-auto h-10"
        />
      </div>
...
const animals = ref([
  {
    ...
    color: "#d03125",
    image: "/my-porfolio/images/icon_1.png",
    animalImage: "/my-porfolio/images/animal_1.png",
  },
  {
    id: 2,
    name: "盒马",
    ...
    color: "#134e91",
    image: "/my-porfolio/images/icon_2.png",
    animalImage: "/my-porfolio/images/animal_2.png",
  },
  {
    id: 3,
    name: "票票",
    ...
    color: "#008b8b",
    image: "/my-porfolio/images/icon_3.png",
    animalImage: "/my-porfolio/images/animal_3.png",
  },
  {
    id: 4,
    name: "虾仔",
    englishName: "Xiazai",
    color: "#f6e58d",
    image: "/my-porfolio/images/icon_4.png",
    animalImage: "/my-porfolio/images/animal_4.png",
  },
  {
    id: 5,
    name: "支小宝",
    ...
    color: "#8b008b",
    image: "/my-porfolio/images/icon_5.png",
    animalImage: "/my-porfolio/images/animal_5.png",
  },
  {
    id: 6,
    name: "欢猩",
    ...
    color: "#8b4513",
    image: "/my-porfolio/images/icon_6.png",
    animalImage: "/my-porfolio/images/animal_6.png",
  },
]);
...
const getImagePath = (number) => {
  ...
  return `/my-porfolio/images/history_${number}.png`;
};
